<div id="othleft-sidebar">
			...
			'items'=>array(
			// The MailBox Link
			array('label'=>''.t('MailBox (' . Yii::app()->getModule('message')->getCountUnreadedMessages(Yii::app()->user->getId()) . ')<span>Send / Receive Messages</span>'), 'url'=>array('/message/inbox'),'linkOptions'=>array('id'=>'menu_3','class'=>'menu_3'), 'itemOptions'=>array('id'=>'menu_1'),
					       'items'=>array(
