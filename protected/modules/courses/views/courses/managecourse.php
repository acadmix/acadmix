...
<h1>Manage Classes & Divisions</h1><br />
 <div id="jobDialog">
 <div id="jobDialog1">
 <?php 
  $posts=Courses::model()->findAll("is_deleted 	=:x", array(':x'=>0));
...
<div class="mcbrow">
	<ul>
    	<li class="col1">Class Name</li>
        <li class="col2">Edit</li>
        <li class="col3">Delete</li>
        <li class="col4">Add Division</li>
        <li class="col5">View Division</li>
    </ul>
 <div class="clear"></div>
</div>
...
<div class="cbtablebx" id="dropwin<?php echo $posts_1->id; ?>" style="display: none; ">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr class="cbtablebx_topbg">
			<td style="text-align:left; padding-left:40px;">Division Name</td>
			<td>Start Date</td>
			<td>End Date</td>
...
<div class="yellow_bx" style="background-image:none;width:680px;padding-bottom:45px;">
                    ...
                    <div class="y_bx_list" style="width:650px;">
                    	<h1><?php echo CHtml::link('Add New Class &amp; Division',array('courses/create')) ?></h1>
                    </div>
