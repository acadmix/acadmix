...
<div class="emp_cont_left">
    ...
    <li class="img_text">
    	<strong>Division: </strong><?php echo $batch->name; ?><br>
    ...
    <?php $time='nt_red'; ?>
    	...
    	<span>Notice</span>
        No Division weekdays are defined.Default Settings Selected.<br />
    	...
    	<span>Notice</span>
        No Division Class Timings are defined.<br />
   ...
   <?php /*?> <li><a class="copy" href="#">Copy Division Settings<span class="active"></span></a></li><?php */?>
    <li><?php echo CHtml::link('Promote Division', array('batches/promote','id'=>$_REQUEST['id']),array('class'=>'promote')) ?></li>
    <?php if($batch->is_active=='1')
	{?>
    <li><?php echo CHtml::link('Deactivate Division', array('batches/deactivate','id'=>$_REQUEST['id']),array('confirm'=>'Are You Sure,Deactivate This Division ?','class'=>'deactivate last')) ?></li><?php }
	else
	{ ?>
    <li><?php echo CHtml::link('Activate Division', array('batches/activate','id'=>$_REQUEST['id']),array('confirm'=>'Are You Sure,Activate This Division ?','class'=>'deactivate last')) ?></li><?php }?>
