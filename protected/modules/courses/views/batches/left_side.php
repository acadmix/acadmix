...
<div class="emp_cont_left">
   ...
   <?php /*?> <li><a class="copy" href="#">Copy Division Settings<span class="active"></span></a></li><?php */?>
	...
	{?>
    <li><?php echo CHtml::link('Deactivate Division', array('batches/deactivate','id'=>$_REQUEST['id']),array('confirm'=>'Are You Sure,Deactivate This Batch ?','class'=>'deactivate last')) ?></li><?php }
	else
	{ ?>
