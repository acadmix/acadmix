   ...
   <!-- <div class="c_subbutCon" align="right" style="width:100%">
    ...
    <div class="table_listbx">
     <?php
				...
				{
					echo '<br><div class="notifications nt_red" style="padding-top:10px"><i>No Active Students In This Division</i></div>'; 
    ...
    <div class="table_listbx">
     <?php
				...
				{
					echo '<br><div class="notifications nt_red" style="padding-top:10px"><i>No Active Student In This Division</i></div>'; 
