...
<div class="emp_right" style="padding-bottom:250px;">
    ...
    <div class="setbx_con">
    	...
    	<div class="setbx_bot">
    		<ul>
    			<?php /*?><li><a class="icon1" href="#">Add Division Admins<span>Admins &amp; Class Teachers</span></a></li>
    			<li><a class="icon2" href="#">Add New Event<span>Admins &amp; Class Teachers</span></a></li><?php */?>
    			<li>
                <?php echo CHtml::link('Promote Division<span>Admins &amp; Class Teachers</span>', array('batches/promote','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon3')) ?></li>
                <?php /*?><li><a class="icon4" href="#">Copy Division Settings<span>Admins &amp; Class Teachers</span></a></li><?php */?>
    		</ul>
    	</div>
    	<div class="clear"></div>
    	</div>
    <div class="clear"></div>
    	...
    	<div class="setbx_bot">
   			<ul>
    			...
    			<li><?php echo CHtml::link('Add Subject to Division<span>Admins &amp; Class Teachers</span>', array('/courses/subject','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon6')) ?></li>
