...
echo '<strong>Select Class</strong>';
...
echo CHtml::dropDownList('cid','',$data,array('onchange'=>'course()','id'=>'coursedrop','empty'=>'Select Class','options'=>array($sel=>array('selected'=>true)))); 
echo '<br>';
