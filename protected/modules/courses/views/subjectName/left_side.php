			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
                                        ...
                                        //array('label'=>''.t('List Subjects<span>Diplay all subject names </span>'), 'url'=>array('index')),                 
                                        array('label'=>''.t('Manage Classes<span>Add Classes</span>'), 'url'=>array('courses/managecourse')),
                                        array('label'=>''.t('Create Subjects<span>Add subject names</span>'), 'url'=>array('create')),
                                        array('label'=>''.t('Manage Subjects<span>Manage Actions</span>'), 'url'=>array('admin')),
