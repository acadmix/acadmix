                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr class="pdtab-h">
                      ...
                      <td align="center">Class/Division</td>
...
<div class="yellow_bx" style="background-image:none;width:680px;padding-bottom:45px;">
                    ...
                    <div class="y_bx_list" style="width:650px;">
                        ...
                        <p>Before Creating Students, make sure you created <?php echo CHtml::link('Student Categories',array('/students/studentCategory')) ?> and the <?php echo CHtml::link('Classes &amp; Divisions',array('/courses/courses/create')) ?> for enrolling Students.</p>
                    </div>
