...
<div class="input">
    <?php echo "<label>School Unique Id</label>";//echo CHtml::activeLabel($model, 'dbName'); ?>
    <?php echo CHtml::activeTextField($model, 'dbName', array('class' => 'text1')); ?>
    <div class="note">School database will be created with this unique identifier</div>
</div>
<div class="input">
