    ...
    return $message;
			...
			'items'=>array(
					...
					/*array('label'=>''.t('Create Employee<span>Manage your Dashboard</span>'),  'url'=>array('employees/create'),'linkOptions'=>array('class'=>'menu_1' ), 'itemOptions'=>array('id'=>'menu_1') 
                            ...
                            //Added Menus
                            array('label'=>''.t('Create Categories<span>Manage employee categories</span>'),  'url'=>array('employeeCategories/create'),'linkOptions'=>array('class'=>'menu_1' ), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
                            array('label'=>''.t('Create Departments<span>Manage employee departments</span>'),  'url'=>array('employeeDepartments/create'),'linkOptions'=>array('class'=>'menu_2' ), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
                            array('label'=>''.t('Create Positions<span>Manage employee positions</span>'),  'url'=>array('employeePositions/create'),'linkOptions'=>array('class'=>'menu_3' ), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
                            array('label'=>''.t('Create Grades<span>Manage employee grades</span>'),  'url'=>array('employeeGrades/create'),'linkOptions'=>array('class'=>'menu_3' ), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
                            
					array('label'=>''.t('Employee Leave Management<span>Manage your Dashboard</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_4','class'=>'menu_4'),  'itemOptions'=>array('id'=>'menu_4'),
					       'items'=>array(
