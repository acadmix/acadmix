...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><?php echo $form->dropDownList($model,'employee_position_id',CHtml::listData(EmployeePositions::model()->findAll(),'id','name'),array('empty' => 'Select Position')); ?>
		<?php echo $form->error($model,'employee_position_id'); ?></td>
    
  	<td><?php echo $form->labelEx($model,'employee_category_id'); ?></td>
    <td><?php echo $form->dropDownList($model,'employee_category_id',CHtml::listData(EmployeeCategories::model()->findAll(),'id','name'),array('empty' => 'Select Category')); ?>
		<?php echo $form->error($model,'employee_category_id'); ?></td>
    
  </tr>
  <tr>
    <td><?php echo $form->labelEx($model,'employee_grade_id'); ?></td>
    <td><?php echo $form->dropDownList($model,'employee_grade_id',CHtml::listData(EmployeeGrades::model()->findAll(),'id','name'),array('empty' => 'Select Grade')); ?>
