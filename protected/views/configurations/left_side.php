    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.t('General Settings<span>Set general configurations </span>'),  'url'=>array('/configurations/index'),'linkOptions'=>array('class'=>'menu_1' ), 'itemOptions'=>array('id'=>'menu_1') 
						 ...
						 'items'=>array(
						  ...
						  array('label'=>t('Manage Users'), 'url'=>array('/user/admin')),
                                                  array('label'=>t('Manage Roles & Rights'), 'url'=>array('/rights')))
						   ),
					...
					array('label'=>''.t('Classes & Divisions<span>Add a new Class or Division</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_2','class'=>'menu_2'),  'itemOptions'=>array('id'=>'menu_2'),
					       'items'=>array(
						array('label'=>t('List Classes & Divisions'), 'url'=>array('courses/courses/managecourse')),
						
						array('label'=>t('Create Classes'), 'url'=>array('courses/courses/create'),
							'active'=> ((Yii::app()->controller->id=='courses') && (in_array(Yii::app()->controller->action->id,array('update','view','admin','index'))) ? true : false)                                                                                           
						      ),
							  //array('label'=>t('Create Divisions'), 'url'=>'#',
...
//						
//					    array('label'=>t('Subject-Division Association'), 'url'=>array('/courses/subjects/index'),
//								'active'=> ((Yii::app()->controller->id=='subjects') && (in_array(Yii::app()->controller->action->id,array('update','view','admin','index'))) ? true : false)),
//						array('label'=>t('View Subject-Division Association'), 'url'=>array('/courses/subjects/admin'),),
//						
//						
//					    
//						
...
//					    )),
						...
						/*array('label'=>''.t('Division-Settings<span>Manage your Dashboard</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_3','class'=>'menu_3'), 'itemOptions'=>array('id'=>'menu_3'),
					       'items'=>array(
