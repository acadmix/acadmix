...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="clear"></div>
        ...
        <div class="setbx" style="width:930px;">
    	<div class="setbx_top">
    	<h1>Class/Division Settings</h1>
    	</div>
    	<div class="setbx_bot">
    		<ul>
    			<li><?php echo CHtml::link('Manage Classes<span>Create,Manage &amp; Reorder</span>', array('courses/courses/managecourse'),array('class'=>'icon30')) ?></li>
    			<?php /*?><li><a href="#" class="icon3">Promote Divisions<span>Admins &amp; Class Teachers</span></a></li>
    			<li><a href="#" class="icon4">Copy Division Settings<span>Admins &amp; Class Teachers</span></a></li><?php */?>
                ...
                <li><?php echo CHtml::link('Subject-Division Association<span>Associate Classes to Subjects</span>', array('employees/employeesSubjects/create'),array('class'=>'icon6')) ?></li>
