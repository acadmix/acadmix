...
<li><div onclick="hide('batch')" style="cursor:pointer;">Division</div>
...
<?php $this->endWidget(); ?>
    ...
    { 
	   $j++;
	?>
    <li>Division : <?php echo Batches::model()->findByAttributes(array('id'=>$_REQUEST['Students']['batch_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Students[batch_id]='?>"></a></li>
    <?php } ?>
