...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <tr>
    <td width="50%" height="15"><p>
        <?php echo $form->textField($model,'school_id',array('class'=>'text-input','onblur'=>'clearText(this)','onfocus'=>'clearText(this)','value'=>'School Id')); ?></p></td>
    <td><i><?php echo $form->error($model,'school_id'); ?></i></td>
  </tr>
  <tr>
    <td width="50%" height="15"><p>
