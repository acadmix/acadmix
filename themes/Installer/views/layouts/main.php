...
<div id="container">
    <!-- header -->
    <div id="header">
        <h1><a href="<?php echo Yii::app()->getBaseUrl(true);?>">Welcome to Easy School</a></h1>
        <div class="user">Build : 1.0</div>
...
<li><a href="install.php?r=Install/default/finish">Final step<span>5</span></a></li>-->
    ...
    <!-- footer -->
    <div id="footer">
        <div class="copy">&copy; Copyright 2012 - 2013 &nbsp;All rights reserved.</div>
    </div>
    <!-- footer.end -->
